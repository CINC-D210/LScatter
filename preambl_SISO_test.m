...
snrdB            = 2000;   % Value of SNR used in this experiment
...
% 4.4 估计整数倍偏移p
% [p_est,idx]=findp(yRec_tag(:,2),preamble_p,txGrid(:,2),rxGrid_2048); 
...
%现在每次解调1200个
% bit_seq=tagdecode(p_est, yRec_tag(:,3), txGrid(:,3),idx);
