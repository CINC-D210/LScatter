function decod_bit = mydecodefft1(p_est,yRec_tag, txGrid1,code_len)
N=128;len=72;
data_num=code_len;
repeat=72/code_len;
...
for code_index=0:2^data_num-1
    ...
    code_72=code_temp(:);
    fft_temp=fft(ofdm_tx_time.*[ZEROS1; code_72; ZEROS2]);
    freq_72s(:,code_index+1) = [fft_temp(end-35:end);fft_temp(2:37)];%构造频域调制信号
end
